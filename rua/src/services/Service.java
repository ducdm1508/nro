...
//    }
    ...
    public static String formatTien(long value) {
        if (value >= 1_000_000_000) {
            double ti = value / 1_000_000_000.0;
            return new java.text.DecimalFormat("#,##0.#").format(ti) + " tỉ";
        } else if (value >= 1_000_000) {
            double tr = value / 1_000_000.0;
            return new java.text.DecimalFormat("#,##0.#").format(tr) + "tr";
        } else if (value >= 1_000) {
            double nghin = value / 1_000.0;
            return new java.text.DecimalFormat("#,##0.#").format(nghin) + "k";
        } else {
    ...
    public void addOptionHide(Item item, int numOption) {
        ...
        for (int i4 = 0; i4 < numOption; i4++) {
            ...
            ItemOption option2 = new ItemOption(num2, Util.nextInt(1, Util.nextInt(3, 5)));
