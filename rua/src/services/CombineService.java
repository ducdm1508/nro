...
public class CombineService {
    ...
    public static final int NANG_CAP_BONG_TAI_CAP2 = 511;
    ...
    public static final int NANG_CHI_SO_BONG_TAI_CAP3 = 519;
    ...
    public void showInfoCombine(Player player, int[] index) {
        ...
        switch (player.combineNew.typeCombine) {
            ...
            case NANG_CAP_VAT_PHAM:
                ...
                break;
            case NANG_CAP_BONG_TAI_CAP2:
                NangCapBongTaiCap2.showInfoCombine(player);
                break;
            ...
            case NANG_CHI_SO_BONG_TAI:
                ...
                break;
            case NANG_CHI_SO_BONG_TAI_CAP3:
                NangChiSoBongTaiCap3.nangChiSoBongTai(player);
                break;
        }
    }
    ...
    public void startCombine(Player player) {
        switch (player.combineNew.typeCombine) {
            ...
            case NANG_CAP_VAT_PHAM:
                ...
                break;
            case NANG_CAP_BONG_TAI_CAP2:
                NangCapBongTaiCap2.nangCapBongTai(player);
                break;
            case NANG_CAP_BONG_TAI_CAP3:
