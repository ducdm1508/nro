    ...
    public void openKhiGasHuyDiet(Player player, byte level) {
        ...
        if (clan != null) {
            ...
            if (cm != null) {
                        ...
                        if (clan.isLeader(player)) {
                            ...
                            if (khiGasHuyDiet != null) {
                                if (Util.isAfterMidnight(player.clan.lastTimeOpenKhiGasHuyDiet)) {
                                    ...
                                    if (player.clan.timesPerDayKGHD > 1) {
                ...
                if (player.clan.KhiGasHuyDiet != null) {
                    long lastGo = player.idMark.getLastTimeGoToKGHD();
                    if (!Util.isAfterMidnight(lastGo)) {
                        // Vẫn trong cùng ngày thì không cho vào nữa
                        Service.gI().sendThongBao(player, "Hôm nay bạn đã tham gia Khí Gas Hủy Diệt rồi, hãy quay lại vào ngày mai.");
                        return;
                    }
                }
