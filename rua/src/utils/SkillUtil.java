...
public class SkillUtil {
    ...
    public static int getTempSkillSkillByItemIDNew(int id) {
        // Sách đấm Dragon (66-72)
        if (id >= 66 && id <= 72) {
            return 0; // DRAGON
        }
        // Sách đấm Demon (79-84, 86)
        else if ((id >= 79 && id <= 84) || id == 86) {
            return 2; // DEMON
        }
        // Sách đấm Galick (87-93)
        else if (id >= 87 && id <= 93) {
            return 4; // GALICK
        }
        // Sách Kamejoko (94-100)
        else if (id >= 94 && id <= 100) {
            return 1; // KAMEJOKO
        }
        // Sách Masenko (101-107)
        else if (id >= 101 && id <= 107) {
            return 3; // MASENKO
        }
        // Sách Atomic (108-114)
        ...
        // Thái dương hạ san (115-121)
        else if (id >= 115 && id <= 121) {
            return 6; // THAI_DUONG_HA_SAN
        }
        // Trị thương (122-128)
        else if (id >= 122 && id <= 128) {
            return 7; // TRI_THUONG
        }
        // Tái tạo năng lượng (129-135)
        else if (id >= 129 && id <= 135) {
            return 8; // TAI_TAO_NANG_LUONG
        }
        // KaioKen (300-306)
        else if (id >= 300 && id <= 306) {
            return 9; // KAIOKEN
        }
        // Quả cầu kênh khí (307-313)
        else if (id >= 307 && id <= 313) {
            return 10; // QUA_CAU_KENH_KHI
        }
        // Biến khí (314-320)
        else if (id >= 314 && id <= 320) {
            return 13; // BIEN_KHI
        ...
        // Makankosappo (328-334)
        else if (id >= 328 && id <= 334) {
            return 11; // MAKANKOSAPPO
        }
        // Đẻ trứng (335-341)
        else if (id >= 335 && id <= 341) {
            return 12; // DE_TRUNG
        }
        // Khiên năng lượng (434-440)
        else if (id >= 434 && id <= 440) {
            return 19; // KHIEN_NANG_LUONG
        }
        // Socola (474-480)
        else if (id >= 474 && id <= 480) {
            return 18; // SOCOLA
        ...
        // Dịch chuyển tức thời (488-494)
        else if (id >= 488 && id <= 494) {
            return 20; // DICH_CHUYEN_TUC_THOI
        }
        // Thôi miên (495-501)
        else if (id >= 495 && id <= 501) {
            return 22; // THOI_MIEN
