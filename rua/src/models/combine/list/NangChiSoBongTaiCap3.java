    ...
    public static void nangChiSoBongTai(Player player) {
        try {
            ...
            if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                ...
                // random 2 option khác nhau
                int idx1 = Util.nextInt(0, option.length - 1);
                int idx2;
                do {
                    idx2 = Util.nextInt(0, option.length - 1);
                } while (idx2 == idx1);

                byte optionid1 = option[idx1];
                byte optionid2 = option[idx2];
                byte param1 = (byte) Util.nextInt(5, 15);
                byte param2 = (byte) Util.nextInt(5, 15);

                BongTai3.itemOptions.add(new Item.ItemOption(optionid1, param1));
                BongTai3.itemOptions.add(new Item.ItemOption(optionid2, param2));
                BongTai3.itemOptions.add(new Item.ItemOption(38, 0));
                BongTai3.itemOptions.add(new Item.ItemOption(72, 2));
