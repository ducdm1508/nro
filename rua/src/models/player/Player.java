...
//                }
    ...
    public static final short[][] idOutfitMafuba = {
        {1221, 1222, 1223}, {1224, 1225, 1226}, {1218, 1219, 1220}
    };
    ...
    public short getHead() {
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            // Kiểm tra item 1111 + 1112
            if (this.pet != null
                    && inventory != null
                    && inventory.itemsBody.get(5) != null
                    && inventory.itemsBody.get(5).isNotNullItem()
                    && this.pet.inventory != null
                    && this.pet.inventory.itemsBody.get(5) != null
                    && this.pet.inventory.itemsBody.get(5).isNotNullItem()
                    && (
                    (inventory.itemsBody.get(5).template.id == 1590
                            && this.pet.inventory.itemsBody.get(5).template.id == 1746)
                            ||
                            (inventory.itemsBody.get(5).template.id == 1746
                                    && this.pet.inventory.itemsBody.get(5).template.id == 1590)
            )) {
                return idOutfitFusion[9][0];// hoặc [1] tùy logic bạn muốn
            }
            ...
            if (this.pet != null
                    ...
                    && this.pet.inventory.itemsBody.get(5).isNotNullItem()
                    && (
                    (inventory.itemsBody.get(5).template.id == 1553
                            && this.pet.inventory.itemsBody.get(5).template.id == 1693)
                            ||
                            (inventory.itemsBody.get(5).template.id == 1693
                                    && this.pet.inventory.itemsBody.get(5).template.id == 1553)
            )) {
                return idOutfitFusion[10][0];// hoặc [1] tùy logic bạn muốn
            }
...
// Hợp thể Porata cấp 3 (bông tai cấp 3)
    ...
    public short getBody() {
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            // ƯU TIÊN kiểm tra item 1111 + 1112 trước
            if (this.pet != null
                    && inventory != null
                    && inventory.itemsBody.get(5) != null
                    && inventory.itemsBody.get(5).isNotNullItem()
            ...
            if (this.pet != null
                ...
                return idOutfitFusion[10][1];// hoặc [1] tùy logic bạn muốn
            }
    ...
    public short getLeg() {
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            if (this.pet != null
                ...
                return idOutfitFusion[10][2];// hoặc [1] tùy logic bạn muốn
            }
    ...
    public short getFlagBag() {
        ...
        if (this.isPet && this.inventory.itemsBody.size() >= 10) {
            if (this.inventory.itemsBody.get(10).isNotNullItem()) {
                return this.inventory.itemsBody.get(10).template.part;
            }
        }
        if (this.clan != null) {
    ...
    public void sendNewPet() {
        if (isPl() && inventory != null && inventory.itemsBody.get(10) != null) {
            Item it = inventory.itemsBody.get(10);
