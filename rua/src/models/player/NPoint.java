...
public class NPoint {
    ...
    private void setDemonFost() {
        this.isDemonFost = false;
        ...
        for (Item item : player.inventory.itemsBody) {
            if (item.isNotNullItem() && item.itemOptions != null) {
                for (Item.ItemOption io : item.itemOptions) {

                    if (io.optionTemplate != null && io.optionTemplate.id == 179) {
                        this.isDemonFost = true;
    ...
    private void setHpMax() {
        ...
        if (this.player.pet != null && this.player.fusion != null && this.player.fusion.typeFusion != ConstPlayer.NON_FUSION
                && this.player.inventory != null
                && this.player.inventory.itemsBody.get(5) != null
                && this.player.inventory.itemsBody.get(5).isNotNullItem()
                && this.player.pet.inventory != null
                && this.player.pet.inventory.itemsBody.get(5) != null
                && this.player.pet.inventory.itemsBody.get(5).isNotNullItem()
                && (
                (this.player.inventory.itemsBody.get(5).template.id == 1553
                        && this.player.pet.inventory.itemsBody.get(5).template.id == 1693)
                        ||
                        (this.player.inventory.itemsBody.get(5).template.id == 1693
                                && this.player.pet.inventory.itemsBody.get(5).template.id == 1553)
        )) {
            hpMax += (hpMax * 5 / 100L);
        }
...
//        }
        ...
        if (this.tlDame179 > 0) {
            long bonusDame = Math.min(this.tlDame179, 10);
    ...
    private long lastTimeUpdateOption179;
